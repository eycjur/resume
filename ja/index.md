...
# Kmuto - 機械学習・生成AI・AIガバナンスエンジニア

1999年生まれ。機械学習エンジニア・ソリューション/ソフトウェアエンジニアとして、**生成AI**や**AIガバナンス**に関するプロダクト開発・導入を手がけています。  
幅広い技術に関心を持ち、オープンソースや技術コミュニティでも積極的に活動中。
...
### Citadel AI（2025年4月〜現在）

- Solutions Engineer & Software Engineerとして、AIガバナンス関連プロダクトの開発・導入に従事。
- 生成AIの品質評価、セキュリティ、プリセールスなど、顧客とプロダクトをつなぐ役割を担う。

### ブレインパッド株式会社（2022年4月〜2025年3月）

- 機械学習エンジニアとして、機械学習・生成AIを活用したシステム開発に従事。
- Python（FastAPI）を中心にバックエンドを構築、TypeScript（Vue.js）でフロントエンド開発、GCP/Azureを利用したクラウド運用。
- 生成AIのチャットボット開発や導入支援を多数実施。
...
### オープンソース貢献
- [BerriAI/litellm](https://github.com/BerriAI/litellm/pulls?q=is%3Apr+author%3Aeycjur+is%3Aclosed) などを中心に複数のPRを提出。
